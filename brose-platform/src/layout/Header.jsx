...
const PAGE_LABELS = { dashboard: 'Dashboard', master_data: 'Master Data', transactions: 'Transactions', production: 'Production', settings: 'Settings' };
...
export default function Header({ pageTitle }) {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (res.ok) { setPwSuccess('Password changed successfully.'); setPwForm({ current: '', newPw: '', confirm: '' }); }
