...
import brose1 from '../../assets/brose1.png';
import brose2 from '../../assets/brose2.png';
...
const pages = [
  ...
  {
    icon: <SettingOutlined style={{ fontSize: 28, color: colors.warning }} />,
    title: 'Settings',
    tag: 'Admin',
    tagColor: 'orange',
    description: 'Manage user accounts — create employees, assign roles, and control page-level permissions. View your own profile and change your password securely.',
  },
];
  ...
  return (
    <div style={{ fontFamily: constants.fontFamily }}>
      ...
      <div style={s.hero}>
        ...
        <img src={brose1} alt="Brose" style={s.heroImg} />
      </div>
        ...
        <Timeline
          items={[
            ...
            },
            {
              ...
              children: (
                <div>
                  <div style={s.timelineLabel}>Manage Users & Access</div>
                  <div style={s.timelineDesc}>Admins create employees, assign roles, and control page-level permissions via Settings.</div>
                </div>
              ),
            },
          ]}
      ...
      <Card style={s.card}>
        ...
        <Divider style={{ margin: `${constants.spacing.lg} 0` }} />
        <img
          src={brose2}
          alt="Brose Plant"
          style={{
